/*
  # Fix Orders and User Profile Permissions - Final Fix

  1. Changes
    - Drop and recreate all order-related policies with proper permissions
    - Fix user profile access and trigger
    - Add missing RLS policies
  
  2. Security
    - Ensure proper RLS for all tables
    - Fix permission issues with orders and profiles
*/
